...
import { CarouselTendance } from '@/components/ui/carouselTendance'

type Props = {}

export default function Tendance({}: Props) {
  return (
    <section className='flex flex-col md:flex-row gap-4 mt-[3rem]'>
        ...
        <div className='flex-2 flex flex-col gap-8 bg-white'>
            ...
            <div className='w-full flex flex-col items-center justify-center md:flex-row md:items-start  gap-4'>
                <CardTendance name='FC Barcelone Visca Barca ' image='/article/maillot2.jpg' />
                <CardTendance name="Paris c'est magique" image='/article/maillot1.jpg' />
                <CardTendance name='Forza Napolitano' image='/article/maillot4.jpg' />
            </div>
        </div>
