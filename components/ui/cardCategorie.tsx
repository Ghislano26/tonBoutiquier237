...
export default function CardCategorie({name, price, quantity, description, link}: Props) {
  return (
    <div className='p-6 md:w-[40%] flex flex-col md:p-5 gap-3 h-auto bg-white rounded-2xl shadow-2xl hover:scale-90 transition-transform'>

        <span className='font-bold text-[1.2rem]'>{quantity} produits</span>
